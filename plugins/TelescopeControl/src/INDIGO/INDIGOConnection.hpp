...
#ifndef INDIGOCONNECTION_HPP
#define INDIGOCONNECTION_HPP
...
class INDIGOConnection final : public QObject, public INDI::BaseClient
{
	Q_OBJECT
...
public:
	...
	INDIGOConnection(QObject* parent = nullptr);
	INDIGOConnection(const INDIGOConnection& that) = delete;
