...
#include "ui_INDIGOControlWidget.h"

INDIGOControlWidget::INDIGOControlWidget(QSharedPointer<TelescopeClient> telescope, QWidget *parent) :
	QWidget(parent),
	ui(new Ui::INDIGOControlWidget),
...
INDIGOControlWidget::~INDIGOControlWidget()
{
	delete ui;
}

double INDIGOControlWidget::speed() const
{
